...
const SingleClassRegisterJsonPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleClassRegisterJsonId, { query: { $populate: [] }})
            .then((res) => {
                set_entity(res || {});
    ...
    const goBack = () => {
        navigate("/classRegisterJson", { replace: true });
    };
    return (
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">ClassRegisterJson</h3>
                </div>
                <p>classRegisterJson/{urlParams.singleClassRegisterJsonId}</p>
            </div>
...
export default connect(mapState, mapDispatch)(SingleClassRegisterJsonPage);
